...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "+94 76 101 2634",
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "yasindubalasooriya125@gmail.com",
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Adress",
    description: "No 140 Arukwatta, Padukka, Sri Lanka",
  },
];
          ...
          <div className="xl:w-[54%] order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              ...
              <p className="text-white/60">
                ...
                opportunities., so feel free to get in touch.
              </p>
              {/* Input Fields */}
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectGroup>
                    ...
                    <SelectItem value="map">Mobile App Development</SelectItem>
